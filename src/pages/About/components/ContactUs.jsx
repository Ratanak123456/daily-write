      ...
      >
        ...
        >
          ...
          >
            {/* Illustration Area */}
            <motion.div
              className=" hidden lg:block relative mx-auto lg:mx-0 w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl mb-4 sm:mb-6 md:mb-8"
        ...
        {showSuccess             <motion.div            <motion.div (
          <motion.div
        ...
        {showSuccess               className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"              className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg" (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess               style={{ backgroundColor: "var(--primary-500)" }}              style={{ backgroundColor: "var(--primary-500)" }} (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess               initial={{ x: 100, opacity: 0 }}              initial={{ x: 100, opacity: 0 }} (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess               animate={{ x: 0, opacity: 1 }}              animate={{ x: 0, opacity: 1 }} (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess               exit={{ x: 100, opacity: 0 }} (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess               transition={{ type: "spring", stiffness: 200 }}              transition={{ type: "spring", stiffness: 200 }} (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess               <Check size={18} className="text-white" />              <Check size={18} className="text-white" /> (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess               <span className="text-white text-sm font-medium">              <span className="text-white text-sm font-medium"> (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess                 {t("about.contact.success")}                {t("about.contact.success")} (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess                 onClick={() => setShowSuccess(false)}                onClick={() => setShowSuccess(false)} (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess                 className="ml-2 p-1 hover:bg-white/20 rounded-full transition-colors"                className="ml-2 p-1 hover:bg-white/20 rounded-full transition-colors" (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess                 <X size={14} className="text-white" />                <X size={14} className="text-white" /> (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
        ...
        {showSuccess         </AnimatePresence>        </AnimatePresence> (
          <motion.div
            className="fixed bottom-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg"
            style={{ backgroundColor: "var(--primary-500)" }}
            initial={{ x: 100, opacity: 0 }}
